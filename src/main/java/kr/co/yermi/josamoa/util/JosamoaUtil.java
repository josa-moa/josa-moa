...
public class JosamoaUtil { 
	...
	/**
	 * 
	 * @param str : 입력되어진 문자열의 끝단어(한글)을 반환합니다.
	 ...
	 * @return 단어의 가장 끝 영문자를 한글표기법 규칙에 맞춰 문자값으로 반환합니다.
	 * 
	 * <pre>
	 *- 글자 길이가 3글자 이상일 경우
	...
	/**
	 * 
	 * @param str : 문자열의 끝단어가 특수문자인지 확인합니다.
	 * @return 문자열의 끝단어가 특수문자일 경우 정해진 규칙에 따라 반환합니다.
	 * 
	 * <pre>
	 *1) ! ? , . ~ ' " ; : { } [ ] ( ) < > 는 무시합니다.
	 *2) @ # % & * 등은 받침없음으로 처리합니다.
