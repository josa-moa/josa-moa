...
public class Josamoa {
	 ...
	 * @return 받침이 있는 경우 두 받침 중 앞 글자를, 받침이 없는 경우 두 받침 중 뒷 글자를 반환합니다.
	 * 
	 *<pre>
	 *- 한글의 경우 받침의 유무를 기준으로 조사를 붙입니다.
	 *- 숫자의 경우 숫자를 한글로 표기한 후 받침 유무를 판단하여 조사를 붙입니다.
	 *- 영어의 경우 정해진 규칙에 따라 조사를 붙입니다.(<code>checkedAlpabet()</code> 참조)
	 *- 문장부호로 쓰이는 특수문자의 경우 정해진 규칙에 따라 조사를 붙입니다.(<code>removeSpecial()</code> 참조)
	 *  
	 *예)
